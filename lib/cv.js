...
let requirePath = path.join(__dirname, process.env.BINDINGS_DEBUG ? '../build/Debug/opencv4nodejs' : '../build/Release/opencv4nodejs')
...
let cv = null
try {
  if (process.env.OPENCV4NODEJS_PKG_MODULE) {
    requirePath = process.env.OPENCV4NODEJS_PKG_MODULE;
  }
